...
export const DEFAULT_BATTLE_TIMINGS = Object.freeze({
  ...
  [BATTLE_EVENT.FUSE]: 620,
  [BATTLE_EVENT.CARD_TRANSFORM]: 760,
  [BATTLE_EVENT.FOLLOWER_ENTER]: 460,
  [BATTLE_EVENT.AMULET_ENTER]: 460,
  [BATTLE_EVENT.ENGAGE]: 560,
  [BATTLE_EVENT.COUNTDOWN_TICK]: 360,
  [BATTLE_EVENT.AMULET_DESTROYED]: 520,
  [BATTLE_EVENT.CARD_BANISHED]: 520,
  [BATTLE_EVENT.CARD_RETURNED]: 480,
  ...
  [BATTLE_EVENT.CREST_GAINED]: 620,
  [BATTLE_EVENT.CREST_TICK]: 360,
  [BATTLE_EVENT.CREST_ACTIVATE]: 560,
  [BATTLE_EVENT.CREST_EXPIRED]: 520,
...
export class BattleAnimationQueue {
  ...
  enqueue(event, context = {}) {
    const job = this.tail.then(() => this.play(event, context));
    this.tail = job.catch(() => {});
    return job;
  }
